...
class TFRecordDataLoader(DataLoader):
    ...
    def _parse_example(
        ...
        with tf.device("/cpu:0"):
            ...
            return {'input':depth}, {'seg': seg, 'quality': quality, 'angle_sin': angle_sin, 'angle_cos': angle_cos, 'gripper_width': gripper_width}
...
class TFGraspConfigurationRecordDataLoader(DataLoader):
    def __init__(self, config: dict, mode: str) -> None:
        """
        An example of how to create a dataset using tfrecords inputs
        :param config: global configuration
